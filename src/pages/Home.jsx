...
import Image1 from '../assets/IMG-20220830-WA0002.jpg'
import Image2 from '../assets/IMG-20220830-WA0003.jpg'
import Image3 from '../assets/IMG-20220830-WA0004.jpg'
...
function Home() {
  ...
  React.useEffect(()=> {
    document.title = "Home | FollowTaxes"
  }, [])
    ...
    <Col className="overflow-hidden">
      <Col className="">
        ...
        <Splide options={{
			...
			<SplideSlide>
				<img src={Image1} data-splide-lazy={Image1} alt="Image 1" className="w-100"/>
			</SplideSlide>
			<SplideSlide>
				<img src={Image2} data-splide-lazy={Image2} alt="Image 1" className="w-100"/>
			</SplideSlide>
			<SplideSlide>
				<img src={Image3} data-splide-lazy={Image3} alt="Image 1" className="w-100"/>
			</SplideSlide>
		</Splide>
        </div>
      </Col>
